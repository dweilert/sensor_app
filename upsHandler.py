...
OVERVIEW:
    Module to monitor the UPS that is connected to the Raspberry Pi. 
...
class INA219:
    ...
    def set_calibration_32V_2A(self):
        ...
        self.config = self.bus_voltage_range << 13 | self.gain << 11 | self.bus_adc_resolution << 7 | self.shunt_adc_resolution << 3 | self.mode
...
def getUPSInfo(returnData):
    try:
        ...
        if (returnData == True):
            ...
            # electirc current and percent charged are returned
