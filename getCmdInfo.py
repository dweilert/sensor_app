...
def getSensorInfo():
    try:
        ...
        results = results + "  USB port 1: \n"
        results = results + "    TTYUSB           : " + cda.usb_port1 + "\n"
        results = results + "    Mapped to sensor : " + config.get("USBPortSignatures", "map_usb_port1_to_sensor") + "\n"
        results = results + "    Critical Errors  : " + str(cda.critical_error_A) + "\n"
        results = results + "  USB port 2: \n"
        results = results + "    TTYUSB           : " + cda.usb_port2 + "\n"
        results = results + "    Mapped to sensor : " + config.get("USBPortSignatures", "map_usb_port2_to_sensor") + "\n"
        results = results + "    Critical Errors  : " + str(cda.critical_error_B) + "\n"
        results = results + "  USB port 3: \n"
        results = results + "    TTYUSB           : " + cda.usb_port3 + "\n"
        results = results + "    Mapped to sensor : " + config.get("USBPortSignatures", "map_usb_port3_to_sensor") + "\n"
        results = results + "    Critical Errors  : " + str(cda.critical_error_C) + "\n"
        results = results + "  USB port 4: \n"
        results = results + "    TTYUSB           : " + cda.usb_port4 + "\n"
        results = results + "    Mapped to sensor : " + config.get("USBPortSignatures", "map_usb_port4_to_sensor") + "\n"
        results = results + "    Critical Errors  : " + str(cda.critical_error_D) + "\n"
        results = results + "\n"
        return results
    except Exception as e:
        exception_type, exception_object, exception_traceback = sys.exc_info()
