...
def getSensorInfo():
    try:
        ...
        results = results + "    USB port       : " + cda.usb_port1 + "\n"
        ...
        results = results + "    USB port       : " + cda.usb_port2 + "\n"
        ...
        results = results + "    USB port       : " + cda.usb_port3 + "\n"
        ...
        results = results + "    USB port       : " + cda.usb_port4 + "\n"
